...
from utils.sci_image_utils import parang_sort, wdhprep_image_frames_parangs
...
class ParametricWDH:
    ...
    def prep_dataset(self):
        ...
        input_data, par_angs, wdh_angs, model_pa_mask = wdhprep_image_frames_parangs(filelist,
