...
class MagAOXData(object):
   ...
   ### Class Initialization ###
    ...
    configfile = package_directory + "/" + "MagAOX.ini"
    ...
    try:
        ...
        print("Error reading MagAO-X configuration file: {0}".format(e.message))
        raise e
   ...
   ###    Constructors     ###
    ...
    def __init__(self, filepaths=None, highpass=False):
        ...
        """
        super(MagAOXData, self).__init__()
        self._output = None
   ...
   ###    Methods    ###
    ...
    def readdata(self, filepaths, highpass=False):
        ...
        for index, filepath in enumerate(filepaths):
            cube, center, pa, wv, astr_hdrs, prihdr, star_flux = _magaox_process_file(self, filepath, highpass=highpass)
            data.append(cube)
...
def _magaox_process_file(self, filepath, highpass=False, pool = None):
    ...
    try:
        ...
        pixel_scale = self.pixel_scale #.006 arcsec/pixel (hard coded, defined in MagAOX.ini)
    ...
    return cube, center, parang, astr_hdrs, prihdr
