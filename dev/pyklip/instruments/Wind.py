...
class GenericWDH(Data):
    ...
    @property
    def wdh1pas(self):
        return self._wdh1pas
    @wdh1pas.setter
    def wdh1pas(self, newval):
        self._wdh1pas = newval

    @property
    def wdh2pas(self):
        return self._wdh2pas
    @wdh2pas.setter
    def wdh2pas(self, newval):
        self._wdh2pas = newval
